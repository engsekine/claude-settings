        ...
        <ReactMarkdown
            ...
            components={{
                ...
                code: ({ children, className }) => {
                    ...
                    return <code className="text-foreground text-sm">{children}</code>;
                },
                ...
                h1: ({ children }) => <h1 className="mb-3 font-bold text-2xl">{children}</h1>,
                h2: ({ children }) => <h2 className="mb-2 font-bold text-xl">{children}</h2>,
                h3: ({ children }) => <h3 className="mb-2 font-semibold text-lg">{children}</h3>,
                blockquote: ({ children }) => (
                    <blockquote className="mb-3 border-muted-foreground/30 border-l-4 pl-4 italic">
                        {children}
                    </blockquote>
                ),
                table: ({ children }) => (
