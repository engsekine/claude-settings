...
export const Sidebar = () => {
    ...
    return (
        <>
            ...
            <aside
                className={cn(
                    'flex h-full flex-col border-border border-r bg-sidebar text-sidebar-foreground transition-all duration-200',
            ...
            >
                ...
                <nav className="flex-1 overflow-y-auto p-2" aria-label="会話一覧">
                    {conversations.length === 0 ? (
                        <p className="px-3 py-4 text-center text-muted-foreground text-sm">まだ会話がありません</p>
                    ) : (
